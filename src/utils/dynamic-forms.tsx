...
export const DYNAMIC_FIELDS = {
  ...
  PT_SALES: 'SALES',
  PT_ORG_ADMIN: 'ORG_ADMIN',
  PT_COMMON_MODULE: 'COMMON_MODULE',
  PT_LOYALTY_PROGRAM: 'LOYALTY_PROGRAM',
  PT_CALL_CENTER: 'CALL_CENTER',
  PT_AIR_OPERATIONS: 'AIR_OPERATIONS',
  MT_VENDOR: 'VENDOR',
  MT_SOFTWARE: 'SOFTWARE',
  MT_DEPARTMENT: 'DEPARTMENT',
  MT_ADD_REQUESTER: 'ADD_REQUESTER',
  MT_ADD_AGENT: 'ADD_AGENT',
  MT_ASSET_TYPE: 'ASSETS', // id based
  MT_CONTRACT_TYPE: 'CONTRACTS', // id based
  MT_PURCHASE_ORDER: 'PURCHASE_ORDER',
  MT_TICKETS: 'TICKETS',
  MT_TIME_ENTRIES: 'TIME_ENTRIES',
  MT_TASK: 'TASK',
  MT_CONTACTS: 'CONTACTS',
  MT_COMPANY: 'COMPANY',
  MT_DOCUMENTS: 'DOCUMENTS',
  MT_DOCUMENT_CREATE: 'DOCUMENT',
  MT_DOCUMENT_FOLDER: 'DOCUMENT_FOLDER',
  MT_MEETING: 'MEETING',
  MT_DEAL: 'DEAL',
  MT_GOAL: 'GOAL',
  MT_QUOTE: 'QUOTE',
  MT_DEAL_PIPELINE: 'DEAL_PIPELINE',
  MT_SALES_PRODUCT: 'SALES_PRODUCT',
  MT_CAMPAIGNS_PARENT: 'CAMPAIGNS',
  MT_CAMPAIGN_CREATE: 'CAMPAIGN',
  MT_SMS_MARKETING: 'SMS_MARKETING',
  MT_WHATSAPP_TEMPLATE: 'WHATSAPP_TEMPLATE',
  MT_WHATSAPP_BROADCAST: 'WHATSAPP_BROADCAST',
  MT_DEALS: 'DEAL',
  MT_CAMPAIGNS: 'CAMPAIGN',
  MT_SMS_BROADCAST: 'SMS_BROADCAST',
  MT_SMS_TEMPLATE: 'SMS_TEMPLATE',
  MT_WHATSAPP_MARKETING: 'WHATSAPP_MARKETING',
  MT_CONTACT: 'CONTACTS',
  MT_LIFE_CYCLE_STAGE: 'LIFE_CYCLE_STAGE',
  PT_COMMON: 'COMMON_MODULE',
  MT_EMAIL_FOLDER: 'EMAIL_MARKETING_FOLDER',
  MT_DOCUMENT: 'DOCUMENT',
  MT_ASSET_PARENT: 'ASSET_PARENT',
  MT_TICKETS_PARENT: 'TICKETS_PARENT',
  MT_SERVICES_SETTINGS: 'SERVICES_SETTINGS',
};
