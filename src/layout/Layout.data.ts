...
export const LoyaltyProgramsRoutes: any = [
  ...
  {
    key: AIR_LOYALTY_PROGRAM?.LOYALTY_REWARD,
    label: 'Loyalty',
    icon: LoyaltyImage,
    role: 'Loyalty-Program',
    permissions: [],
    textNames: [
      ...
      {
        key: AIR_LOYALTY_PROGRAM?.LOYALTY_TRANSACTIONS,
        label: 'Transactions',
        permissions: [],
      },
      {
        key: AIR_LOYALTY_PROGRAM?.LOYALTY_RULES_TIERS,
        label: 'Rules & Tiers',
        permissions: [],
      },
      {
        key: AIR_LOYALTY_PROGRAM?.LOYALTY_RULES_VOUCHERS,
        label: 'Vouchers',
        permissions: [],
      },
    ],
  },
  {
    ...
    textNames: [
      ...
      {
        key: AIR_LOYALTY_PROGRAM?.GIFT_CARDS_TRANSACTIONS,
        label: 'Transactions',
        permissions: [],
      },
    ],
