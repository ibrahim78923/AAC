  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography my="8px">
            Select the below account(s) you want to connect to Airapple cart.
          </Typography>
          <Typography my="8px">
            Newly connected accounts may be eligible $500 USD in ad credits.
          </Typography>
          <Typography my="8px">You can connect up to 2 ad accounts</Typography>
        </Box>
