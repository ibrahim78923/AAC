...
import { useConnectPhoneNumberForWhatsAppMarketingMutation } from '@/services/airMarketer/whatsapp-marketing';
...
const useConnectNumber = () => {
  const { setConnectedChangeDetect } = useWhatsAppMarketing();
  ...
  const handelUpdatedAccountSession = ({ id, phoneValue }: any) => {
    setActiveAccountSession({
      ...
      ...(phoneValue && { twilioWhatsappNumber: phoneValue }),
    });
  };
