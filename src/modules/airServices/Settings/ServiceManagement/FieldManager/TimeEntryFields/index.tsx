...
import useTimeEntryFields from './useTimeEntryFields';
...
import { predefinedTimeEntriesDataArray } from './TimeEntryFields.data';
          ...
          <CustomGrid md={8}>
            ...
            >
              <PageTitledHeader
                ...
                moveBack={() => {
                  router?.push({
                    pathname: AIR_SERVICES?.FIELD_MANAGER,
                  });
                }}
              />
            </Box>
            ...
            >
              <DroppableArea
                ...
                overlay={overlay}
                predefinedDataArray={predefinedTimeEntriesDataArray}
                moduleType={DYNAMIC_FIELDS?.MT_TIME_ENTRIES}
                productType={DYNAMIC_FIELDS?.PT_SERVICES}
                successPath={AIR_SERVICES?.FIELD_MANAGER}
